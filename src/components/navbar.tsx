            ...
            <div className="absolute left-0 z-10 w-screen bottom-[5%]">
                ...
                >
                    <div className="menu-parent">
                        ...
                        <Link href="/projects" className="menu-item"><GrProjects /><p>Projects</p></Link>
                        ...
                        <Link href="https://github.com/Fir121" className="menu-item" target="_blank"><FaGithub /><p>GitHub</p></Link>
                    </div>
                </motion.div>
            </div>
        </div>
