...
export default function Home() {
  return (
    ...
    <div className="relative min-h-screen">
      ...
      <div className="mt-5 md:mt-0 relative md:absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-background-trans to-60% p-5 md:p-10 justify-center align-middle flex flex-col gap-7 text-center">
        <MainHeader/>
      </div>
    </div>
